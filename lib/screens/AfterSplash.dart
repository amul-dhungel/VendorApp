...
import 'package:vendr/Controller/CreateProductController.dart';
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  Widget _termsAndCondition() => Column(
        children: [
          text("By clicking Log in or Sign up, you agree with our ",
              fontSize: textSizeSmall, isCentered: true),
          text("Terms of service.",
              lineThrough: true, fontSize: textSizeSmall, isCentered: true)
        ],
      );
        ...
        child: Column(
          ...
          children: [
            ...
            buttonWid(
                ...
                borderColor: c_white,
                function: () {
                  // Get.find<CreateProductController>().createProduct();
